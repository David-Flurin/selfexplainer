...
def get_parser():
    ...
    parser.add_argument('--multilabel', default=False, type=str2bool, help='Whether the objective is multiclass or singleclass.')
    ...
    parser.add_argument('--entropy_regularizer', default=1.0, type=float, help='Path to the .ckpt file that contains the weights of a pretrained classifier.')
    ...
    parser.add_argument('--background_activation_loss', default=False, type=str2bool, help='Whether to use background activation loss on first pass mask')
