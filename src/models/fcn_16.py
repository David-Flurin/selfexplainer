...
class FCN16(BaseModel):
    ...
    use_mask_area_loss=True, use_mask_variation_loss=True, mask_variation_regularizer=1.0, ncmask_total_area_regularizer=0.3, mask_area_constraint_regularizer=1.0, class_mask_min_area=0.04, 
        ...
        super().__init__(num_classes=num_classes, dataset=dataset, learning_rate=learning_rate, weighting_koeff=weighting_koeff, pretrained=pretrained, use_similarity_loss=False, similarity_regularizer=similarity_regularizer, use_background_loss=use_entropy_loss, use_weighted_loss=use_weighted_loss,
